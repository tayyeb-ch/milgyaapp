    ...
    <?php include("partials/navigation.php"); ?>
        ...
        <?php
            if (isset($_POST['submitreview'])) {
                ...
                $addreview = mysqli_query($connection, "INSERT INTO user_reviews(review_from, review_to, item_id, review_description) VALUES('$review_from', '$review_to', '$item_id', '$review_description')");

                if ($addreview) {
                    echo "<div class='alert alert-success'>Review Submited.</div>";
                } else {
                    echo "<div class='alert alert-danger'>Problem submitig review.</div>";
                }
                        ...
                        <div class="product-details">
                            ...
                            <div class="product-slider">
                                <div class="product-slider-item my-4" data-image="<?php echo $itempicturepath; ?>">
                                    <img class="img-fluid w-100" src="<?php echo $itempicturepath; ?>" alt="product-img">
                                </div>
                            </div>
                                                        ...
                                                        <form action="" method="POST" class="row">
                                                            ...
                                                            <div class="review-submit w-100">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <button type="submit" name="submitreview" class="btn btn-main">Sumbit</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget user text-center">
                                ...
                                <ul class="list-inline mt-20">
                                    <li class="list-inline-item"><a href="tel:<?php echo $postedBy['phone']; ?>" class="btn btn-contact d-inline-block  btn-primary px-lg-5 my-1 px-md-3">Contact</a></li>
                                </ul>
                            </div>
