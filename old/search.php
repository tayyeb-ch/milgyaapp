                ...
                <div class="row">
                            ...
                            <div class="col-md-12">
                                <form action="search.php" method="GET">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <input type="text" name="location" class="form-control my-2 my-lg-1" id="inputLocation4" placeholder="Location" required="">
                                        </div>
                    ...
                    <?php
                        ...
                        if (isset($_GET['category_id'])) {
                            ...
                            $latestitems = mysqli_query($connection, "SELECT * FROM  items WHERE category_id = '$category_id' OR title LIKE '%$keyword%' OR description LIKE '%$keyword%' OR location  LIKE '%$location%'");
                        } else {
                            $latestitems = mysqli_query($connection, "SELECT * FROM  items WHERE title LIKE '%$keyword%' OR description LIKE '%$keyword%' OR location  LIKE '%$location%'");
                        }
