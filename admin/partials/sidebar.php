        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="withdraw-requests.php"><i class="fas fa-tachometer-alt"></i>Withdraw Requests</a>
                    </li>
                    
                    <li class="nav-item ">
                        <a class="nav-link" href="reward-setting.php"><i class="fas fa-tachometer-alt"></i>Reward Setting</a>
                    </li>
                    
                    <li class="nav-item ">
                        <a class="nav-link" href="news.php"><i class="fas fa-tachometer-alt"></i>News Ticker</a>
                    </li>
